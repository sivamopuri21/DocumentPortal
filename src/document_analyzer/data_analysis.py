...
from model.models import * # type: ignore
...
class DocumentAnalyzer:
    ...
    def __init__(self):
        ...
        try:
            ...
            raise DocumentPoratalException("Error in DocumentAnalyzer initialization", sys)
    ...
    def analyze_document(self, document_text:str)-> dict:
        ...
        try:
            ...
            raise DocumentPoratalException("Metadata extraction failed",sys)
